...
<img class="sr-shot sr-light" src="/SunReye/screenshots/dashboard-light.png" alt="The SunReye dashboard showing a live power-flow diagram and KPI cards." />
<img class="sr-shot sr-dark" src="/SunReye/screenshots/dashboard-dark.png" alt="The SunReye dashboard showing a live power-flow diagram and KPI cards." />
